-- ========================================
-- COMPLETE FIX - CORRECTED ENUMS
-- Run in pgAdmin Query Tool
-- ========================================

-- STEP 1: Insert Plans (UPPERCASE enums)
-- ========================================
...
-- STEP 3: Create Trial Subscription (UPPERCASE status)
-- ========================================
...
-- ========================================
-- SUCCESS! Now go to Swagger:
-- 1. GET /api/v1/subscription/plans (should show 3 plans)
-- 2. GET /api/v1/subscription/current (should show trial)
-- 3. POST /api/v1/api_key (should create key!)
-- ========================================
