...
const WorkflowAnalyzer = () => {
            ...
            history.forEach((analysis) => {
              if (
                ...
                allWorkflows.push({
                  ...
                  complexity: analysis.result?.complexityLevel || "Medium",
                  activities: analysis.result?.totalActivities || 25,
  ...
  const generateMockAnalysis = (workflow) => {
    ...
    const activityTemplates = [
      {
        ...
        type: "direct",
        effort: 0.2,
        notes: "Direct variable assignment",
      },
      {
        source: "If",
        ...
        type: "direct",
        effort: 0.3,
        notes: "Convert condition to Blue Prism expression",
      },
      {
        source: "While",
        category: "Control Flow",
        ...
        type: "direct",
        effort: 0.5,
        notes: "Convert loop condition to Blue Prism expression",
      },
      {
        source: "ForEach",
        category: "Control Flow",
        target: "Loop (Collection)",
        type: "direct",
        effort: 0.5,
        notes: "Iterate through collection items",
      },
      {
        source: "Sequence",
        category: "Control Flow",
        ...
        type: "direct",
        effort: 0.1,
        notes: "Group activities in a page",
      },
      {
        source: "Flowchart",
        category: "Control Flow",
        ...
        type: "direct",
        effort: 0.2,
        notes: "Convert to Blue Prism process flow",
      },
      {
        source: "InvokeWorkflow",
        category: "Workflow Invocation",
        target: "Process Call",
        type: "direct",
        effort: 0.4,
        notes: "Call another process",
      },
      {
        source: "TryCatch",
        category: "Error Handling",
        target: "Exception Block",
        type: "direct",
        effort: 0.6,
        notes: "Implement error handling",
      },
      {
        source: "Throw",
        category: "Error Handling",
        target: "Exception Stage",
        type: "direct",
        effort: 0.3,
        notes: "Raise exception",
      },
      {
        source: "Log Message",
        category: "Logging",
        ...
        type: "direct",
        effort: 0.2,
        notes: "Log to Blue Prism logs",
      },
      {
        source: "Read Range",
        category: "Excel",
        target: "MS Excel VBO - Get Worksheet",
        type: "partial",
        effort: 1.0,
        notes: "Use Excel VBO for data extraction",
      },
      {
        source: "Write Range",
        category: "Excel",
        target: "MS Excel VBO - Write Collection",
        type: "partial",
        effort: 1.0,
        notes: "Use Excel VBO for data writing",
      },
      {
        source: "Click",
        ...
        type: "partial",
        effort: 0.8,
        notes: "Use Application Modeller for UI interaction",
      },
      {
        source: "Type Into",
        category: "UI Automation",
        ...
        type: "partial",
        effort: 0.7,
        notes: "Use Application Modeller for text input",
      },
      {
        source: "Get Text",
        category: "UI Automation",
        ...
        type: "partial",
        effort: 0.7,
        notes: "Use Application Modeller for text extraction",
      },
    ];
    ...
    for (let i = 0; i < directMappings; i++) {
      ...
      const suffix =
        i >= activityTemplates.length
          ? ` ${Math.floor(i / activityTemplates.length) + 1}`
          : "";
    ...
    for (let i = 0; i < incompatibilityCount; i++) {
      const template =
        incompatibilityTemplates[i % incompatibilityTemplates.length];
      const suffix =
        i >= incompatibilityTemplates.length
          ? ` ${Math.floor(i / incompatibilityTemplates.length) + 1}`
          : "";
      incompatibilities.push({
        activity: template + suffix,
        issue: "No direct mapping available",
        description:
          "Activity not found in mapping database. Manual analysis required.",
        status: "unmapped",
        effort: 2,
      });
    }
            ...
            <>
              ...
              >
                <MetricCard>
                  ...
                  <Typography
                    sx={{ fontSize: "36px", fontWeight: 700, color: "#2196f3" }}
                  >
                ...
                <MetricCard>
                  ...
                  <Typography
                    sx={{ fontSize: "36px", fontWeight: 700, color: "#f44336" }}
                  >
                ...
                <MetricCard>
                  ...
                  <Typography
                    sx={{ fontSize: "36px", fontWeight: 700, color: "#9c27b0" }}
                  >
                ...
                <MetricCard>
                  ...
                  <Typography
                    sx={{ fontSize: "36px", fontWeight: 700, color: "#4caf50" }}
                  >
              ...
              >
                ...
                >
                  <Table>
                    ...
                    <TableBody>
                      {analysisResults.activityMappings.map(
                        (mapping, index) => (
          ...
          {!analysisResults && !analyzing && (
            ...
            >
              <Typography sx={{ color: "#757575", mb: 2 }}>
                No analysis results yet. Configure and run analysis to see
                detailed comparison.
              </Typography>
            </Box>
          )}
